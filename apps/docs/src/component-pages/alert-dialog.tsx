...
const details: ComponentPageDetails = {
  "summary": "Alert Dialog is a overlay in the Alkamanas system. This page documents composition, public props, expected motion and the tokens that keep it consistent across dark and light scopes.",
  "anatomy": [
    "Import AlertDialog from @alkamanas/ui and compose it with the documented subcomponents when the primitive is compound.",
  ...
  "variants": [
    {
      "name": "default",
      "description": "The standard Alert Dialog treatment used in the component preview."
    },
    {
      "name": "themed",
...
export function AlertDialogPage({ doc }: ComponentPageProps) {
