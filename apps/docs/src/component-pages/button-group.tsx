...
const details: ComponentPageDetails = {
  ...
  "anatomy": [
    "Import ButtonGroup from @alkamanas/ui and compose it with the documented subcomponents when the primitive is compound.",
  ...
  "variants": [
    {
      "name": "default",
      "description": "The standard Button Group treatment used in the component preview."
    },
    {
      "name": "themed",
