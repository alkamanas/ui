...
const details: ComponentPageDetails = {
  "summary": "Flip Card is a interaction primitive in the Alkamanas system. This page documents composition, public props, expected motion and the tokens that keep it consistent across dark and light scopes.",
  "anatomy": [
    "Import FlipCard from @alkamanas/ui and compose it with the documented subcomponents when the primitive is compound.",
  ...
  "variants": [
    {
      "name": "default",
      "description": "The standard Flip Card treatment used in the component preview."
    },
    {
      "name": "themed",
...
export function FlipCardPage({ doc }: ComponentPageProps) {
