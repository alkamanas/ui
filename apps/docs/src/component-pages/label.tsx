...
const details: ComponentPageDetails = {
  "summary": "Label is a interaction primitive in the Alkamanas system. This page documents composition, public props, expected motion and the tokens that keep it consistent across dark and light scopes.",
  "anatomy": [
    "Import Label from @alkamanas/ui and compose it with the documented subcomponents when the primitive is compound.",
  ...
  "variants": [
    {
      "name": "default",
      "description": "The standard Label treatment used in the component preview."
    },
    {
      "name": "themed",
...
export function LabelPage({ doc }: ComponentPageProps) {
