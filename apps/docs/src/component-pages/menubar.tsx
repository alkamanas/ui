...
const details: ComponentPageDetails = {
  "summary": "Menubar is a navigation primitive in the Alkamanas system. This page documents composition, public props, expected motion and the tokens that keep it consistent across dark and light scopes.",
  "anatomy": [
...
export function MenubarPage({ doc }: ComponentPageProps) {
