...
const details: ComponentPageDetails = {
  "summary": "Radio Group is a form control in the Alkamanas system. This page documents composition, public props, expected motion and the tokens that keep it consistent across dark and light scopes.",
  "anatomy": [
    "Import RadioGroup from @alkamanas/ui and compose it with the documented subcomponents when the primitive is compound.",
  ...
  "variants": [
    {
      "name": "default",
      "description": "The standard Radio Group treatment used in the component preview."
    },
    {
      "name": "themed",
...
export function RadioGroupPage({ doc }: ComponentPageProps) {
