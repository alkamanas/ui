...
const details: ComponentPageDetails = {
  ...
  "anatomy": [
    "Import Slider from @alkamanas/ui and compose it with the documented subcomponents when the primitive is compound.",
  ...
  "variants": [
    {
      "name": "default",
      "description": "The standard Slider treatment used in the component preview."
    },
    {
      "name": "themed",
