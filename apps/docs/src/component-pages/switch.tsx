...
const details: ComponentPageDetails = {
  "summary": "Switch is a form control in the Alkamanas system. This page documents composition, public props, expected motion and the tokens that keep it consistent across dark and light scopes.",
  "anatomy": [
    "Import Switch from @alkamanas/ui and compose it with the documented subcomponents when the primitive is compound.",
  ...
  "variants": [
    {
      "name": "default",
      "description": "The standard Switch treatment used in the component preview."
    },
    {
      "name": "themed",
...
export function SwitchPage({ doc }: ComponentPageProps) {
