...
const details: ComponentPageDetails = {
  "summary": "Toggle is a interaction primitive in the Alkamanas system. This page documents composition, public props, expected motion and the tokens that keep it consistent across dark and light scopes.",
  "anatomy": [
    "Import Toggle from @alkamanas/ui and compose it with the documented subcomponents when the primitive is compound.",
  ...
  "variants": [
    {
      "name": "default",
      "description": "The standard Toggle treatment used in the component preview."
    },
    {
      "name": "themed",
...
export function TogglePage({ doc }: ComponentPageProps) {
