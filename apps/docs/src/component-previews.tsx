...
export function ComponentPreview({ id }: { id: string }) {
  ...
  if (id === "date-picker") return <div className="grid gap-4"><DatePicker defaultValue={new Date(2026, 4, 20)} /><DatePicker surface="glass" placeholder="Select launch date" calendarProps={{ defaultMonth: new Date(2026, 4, 1) }} /></div>;
