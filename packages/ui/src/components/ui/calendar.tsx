...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      classNames={{
        [UI.Root]: "alka-calendar-root relative",
        ...
        [UI.Nav]: "alka-calendar-nav absolute inset-x-0 top-0 z-10 flex h-9 items-center justify-between",
        [UI.PreviousMonthButton]:
          "alka-calendar-nav-button inline-flex h-9 w-9 cursor-pointer items-center justify-center rounded-full border border-border/70 bg-background/35 text-muted-foreground transition-colors hover:bg-muted/70 hover:text-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring/70 disabled:pointer-events-none disabled:cursor-default disabled:opacity-40",
        [UI.NextMonthButton]:
          "alka-calendar-nav-button inline-flex h-9 w-9 cursor-pointer items-center justify-center rounded-full border border-border/70 bg-background/35 text-muted-foreground transition-colors hover:bg-muted/70 hover:text-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring/70 disabled:pointer-events-none disabled:cursor-default disabled:opacity-40",
        ...
        [UI.DayButton]:
          "alka-calendar-day-button inline-flex h-10 w-10 cursor-pointer items-center justify-center rounded-full text-sm font-medium text-foreground transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring/70 disabled:pointer-events-none disabled:cursor-default",
