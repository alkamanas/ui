...
>(({ className, ...props }, ref) => (
  ...
  >
    <SwitchPrimitives.Thumb
      className={cn(
        "alka-switch-thumb alka-liquid-glass pointer-events-none relative z-10 block h-6 w-9 rounded-full border border-white/14 ring-0 transition-[transform,box-shadow,opacity] duration-500 ease-[var(--alka-ease-smooth)]"
      )}
    >
      <GlassElementLayers />
    </SwitchPrimitives.Thumb>
