...
>(({ children, className, style, ...props }, ref) => {
  ...
  return (
    <TabsPrimitive.List
      ...
      className={cn(
        "alka-tabs-list alka-pill-surface inline-flex h-10 items-center justify-center rounded-full p-1 text-muted-foreground",
        className
      )}
      style={
        {
...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.Trigger
    ref={ref}
    className={cn(
      "relative z-10 inline-flex cursor-pointer items-center justify-center whitespace-nowrap rounded-full px-3 py-1.5 text-sm font-medium ring-offset-background transition-[color,opacity,transform] duration-500 ease-[var(--alka-ease-smooth)] hover:text-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 data-[state=active]:text-foreground",
      className
    )}
    {...props}
  />
